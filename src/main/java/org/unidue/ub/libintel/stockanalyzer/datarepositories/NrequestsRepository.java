...
public interface NrequestsRepository  extends PagingAndSortingRepository<Nrequests, String> {
    ...
    List<Nrequests> getNrequestsForAlertcontrolData(String startNotation, String endNotation, @Temporal(TemporalType.TIMESTAMP) Date startDate, long thresholdDuration, int thresholdNrequests, double thresholdRatio);
